-- Migration: 0115_pms_linked_assignment_causality
...
BEGIN
  ...
  THEN
    ...
    IF NOT FOUND OR assignment_room_type_id IS DISTINCT FROM NEW.source_room_type_id THEN
