...
DROP INDEX CONCURRENTLY IF EXISTS booking.uq_booking_nightly_revenue_evidence_occupancy_target_next;
-- vayada:next-statement
CREATE UNIQUE INDEX CONCURRENTLY uq_booking_nightly_revenue_evidence_occupancy_target_next
