...
| `apps/pms-api/migrations`         | 100        | Fully covered   | Dropped Beds24 and old messaging tables are source snapshot only; PMS DDL added in VAY-672; finance DDL added in VAY-673 for payment/payout dependencies; distribution DDL added in VAY-675; platform webhook/audit DDL added in VAY-676; transforms/parity fixtures not started |
