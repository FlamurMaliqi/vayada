...
| `folio_lines`                                        | Finance                            | Normalized decimal lines belonging to one immutable folio revision.                                         | Generated totals and canonical source evidence reconstruct the snapshot.                                                                         |
