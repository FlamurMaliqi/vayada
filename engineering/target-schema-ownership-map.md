...
| `folios`                                             | Finance                            | New opaque operational folio identities with optional Booking references.                                   | Not an official invoice identity; the external accounting system owns official numbers.                                                         |
| `folio_revisions`                                    | Finance                            | New encrypted, append-only operational folio snapshots.                                                     | Exact recipient, service, currency, total and source evidence remains reconstructable.                                                          |
| `folio_lines`                                        | Finance                            | Normalized decimal lines belonging to one immutable folio revision.                                         | Generated totals and canonical source/mapping evidence reconstruct the snapshot.                                                                |
| `folio_payment_references`                           | Finance                            | Property/currency-scoped references to canonical Finance payments.                                          | Snapshot evidence only; accounting-system allocations are separate.                                                                             |
