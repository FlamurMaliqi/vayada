...
| `public_hotel_bookability_profiles` | Distribution/bookability | Active public Booking revision plus canonical Catalog profile.                                   | Public-safe hotel profile for Booking Web and external search.                          |
| `public_room_offer_snapshots`       | Distribution/bookability | PMS room/rate configuration, live ARI, Booking policy, and Finance readiness.                    | Public-safe snapshot only; no unpublished/private operational data.                     |
