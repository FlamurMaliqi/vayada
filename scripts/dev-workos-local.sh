...
export MARKETPLACE_DISCOVERY_SOURCE="${MARKETPLACE_DISCOVERY_SOURCE:-target}"
export PMS_OPERATIONS_SOURCE="${PMS_OPERATIONS_SOURCE:-target}"
export PMS_OPERATIONS_ALLOWED_ORIGINS="${PMS_OPERATIONS_ALLOWED_ORIGINS:-${PMS_ORIGIN},${PMS_PORTLESS_ORIGIN}}"
