...
export const SEARCH_ENTRIES = [
  ...
  ["Promo Codes", "/promo-codes", "Pages", "settings", ""],
  ["Affiliates", "/affiliates", "Pages", "affiliates", ""],
  ...
  ["Payment Settings", "/settings?section=payments", "Settings", "payments", ""],
  ["Domain Settings", "/design-studio?tab=domain", "Design Studio", "design", ""],
  ["Media and images", "/design-studio?tab=media", "Design Studio", "design", ""],
  ["Themes and colors", "/design-studio?tab=colors", "Design Studio", "design", ""],
  ["Fonts", "/design-studio?tab=fonts", "Design Studio", "design", ""],
  ["Layout", "/design-studio?tab=layout", "Design Studio", "design", ""],
  [
    "Room filters",
