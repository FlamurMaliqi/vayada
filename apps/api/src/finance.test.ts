...
const payoutGuestBookingId = "f6000000-0000-0000-0000-000000000686";
const payoutPaymentId = "pay_manual_002";
...
describe("finance route contracts", () => {
  ...
  it("persists manual payment dedupe and platform side-effect keys by property scope", async () => {
    ...
    expect(paymentInsert.values?.slice(5, 8)).toEqual(["250.00", "12.50", "237.50"]);
