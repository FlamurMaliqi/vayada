        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
              Browse our curated community of verified travel influencers. Find the perfect match
              for your property and start driving direct bookings.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="relative">
              ...
              {hiddenCount > 0 && (
                <div className="relative mt-6">
                  ...
                  {/* CTA Overlay - centered over blurred rows 2 and 3 */}
                  <div className="absolute inset-0 flex items-center justify-center z-10">
                    <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-8 md:p-10 max-w-lg mx-4 text-center">
                      ...
                      <p className="text-gray-600 mb-6 leading-relaxed">
                        Sign up for free to access all verified creators, send collaboration
            ...
            {[
              {
                ...
                title: "Verified Data",
                description:
                  "All creator metrics are verified. No fake followers, no inflated engagement rates.",
              },
              {
                icon: UserGroupIcon,
                title: "Direct Contact",
                description:
                  "Connect directly with creators. No middlemen, no agencies, no hidden fees.",
              },
              {
                icon: SparklesIcon,
                title: "Free to Join",
                description:
                  "Register your property for free. Only pay when you start a paid collaboration.",
              },
      ...
      <section className="bg-gradient-to-r from-primary-600 to-primary-700 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-primary-100 text-lg mb-8 max-w-2xl mx-auto">
            Join vayada for free and get instant access to all {stats.totalCreators} verified travel
            creators.
          </p>
